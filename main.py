...
BUFFER_SIZE = 60000
BATCH_SIZE = 256
IMAGE_GENERATION_CLASS_ID = 3
TRAIN_IMAGES_FOLDER = 'training_images/training_simple_shapes_color'
GENERATED_IMAGES_FOLDER = 'generated_images'
FILE_ENDING = '.png'
CLASS_NAME_ARRAY = ['1 (Square)' , '2 (Circle)', '3 (Triangle)', '4 (Arrow)']
TRAIN_PATH_TO_FILES_ARRAY = [TRAIN_IMAGES_FOLDER+'/1/', TRAIN_IMAGES_FOLDER+'/2/', TRAIN_IMAGES_FOLDER+'/3/', TRAIN_IMAGES_FOLDER+'/4/']
SHOW_IMAGES = True
TRAIN_MODE = True
